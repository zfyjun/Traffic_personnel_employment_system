...
<!--      <el-table-column prop="state" label="考试状态"></el-table-column>-->
    ...
    <el-dialog title="试卷" :visible.sync="dialogFormVisible1">
      <el-form label-width="80px" size="small">
        <el-form-item label="试卷">
          <el-select clearable v-model="form1.paperId" placeholder="请选择" style="width: 100%">
            <el-option v-for="item in papers" :key="item.id" :label="item.name"
                       :value="item.id"
            >
            </el-option>
          </el-select>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="持续时间">
          <el-input v-model="form.duration" placeholder="选择日期时间"></el-input>
        </el-form-item>
